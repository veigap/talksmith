...
**Do not edit this file by hand during a Review round.** Add feedback to the Talk's `draft.md` `Presenter feedback` fields; the Editor role mirrors closed bullets here during its Step 5 pass.
