...
CASES = [
    ...
    ("content+cards+image-1-card",
     [_slide("content+cards+image", cards=[{"label": "L", "body": "b"}], media={"src": "x.png"})],
     1, "one card beside an image is a content-image, not a card set"),
    ("value-columns-1-column",
     [_slide("value-columns", columns=[{"header": "h"}])],
     1, "a single column sets nothing against anything"),
    ("stat-missing-field",
     [_slide("stat")],
