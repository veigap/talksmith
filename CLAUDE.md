...
| Change what `/talksmith:init` copies | [`commands/init.md`](commands/init.md) (copies `talksmith-orch.md` → `CLAUDE.md` and `talksmith-agents.md` → `AGENTS.md` — keep it minimal) |
